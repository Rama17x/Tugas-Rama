...
if'__main__' == __name__:
    ...
    value = 0 #jika mau ubah kie mptcp ubah value menjadi 1
    ...
    net.addLink(r1,r4,cls=TCLink, **bwlink)#r1 - eth1 r2-eth0
    net.addLink(r1,r3,cls=TCLink, **bwlink2)#r1 - eth2 r4-eth0

    net.addLink(r2,h1,cls=TCLink, **bwlink)#r2 - eth0 h1-eth1
    net.addLink(r2,r3,cls=TCLink, **bwlink)#r3 - eth1 r4-eth1
    net.addLink(r2,r4,cls=TCLink, **bwlink2)#r4 - eth2 r2-eth1

    net.addLink(r3,h2,cls=TCLink, **bwlink)#r2 - eth2 h2-eth0
    ...
    #Routing terlebih dulu dengan subneting

    h1.cmd("ifconfig h1-eth0 192.168.0.1 netmask 255.255.255.0")
    h1.cmd("ifconfig h1-eth1 192.168.1.1 netmask 255.255.255.0")

    h2.cmd("ifconfig h2-eth0 192.168.7.1 netmask 255.255.255.0")
    h2.cmd("ifconfig h2-eth1 192.168.6.1 netmask 255.255.255.0")
    ...
    r2.cmd("ifconfig r2-eth1 192.168.4.1 netmask 255.255.255.0")
    r2.cmd("ifconfig r2-eth2 192.168.3.1 netmask 255.255.255.0")

    r3.cmd("ifconfig r3-eth0 192.168.2.2 netmask 255.255.255.0")
    r3.cmd("ifconfig r3-eth1 192.168.4.2 netmask 255.255.255.0")
    ...
    h1.cmd("ip route add default via 192.168.1.2 dev h1-eth1 table 2")
    ...
    h2.cmd("ip route add 192.168.6.0/24 dev h1-eth0 scope link table 2")
    h2.cmd("ip route add default via 192.168.6.2 dev h1-eth0 table 2")
    h2.cmd("ip route add default scope global nexthop via 192.168.7.2 dev h1-eth0")
